[DH-PE.html](https://github.com/user-attachments/files/24374371/DH-PE.html)
<!DOCTYPE html>
<html lang="pt-br">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">[sw.js](https://github.com/user-attachments/files/24374372/sw.js)[manifest.json](https://github.com/user-attachments/files/24374373/manifest.json)
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Inscrição Ouricuri 2026</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
        ...
        .btn-pagar {
            ...
            font-weight: bold;
            font-size: 18px;
            display: none; /* Só aparece ao selecionar categoria */
        }
    </style>
</head>
<body>
    ...
    <div class="header-etapa">
        <p>1ª ETAPA - PERNAMBUCANO 2026</p>
        <h1>OURICURI - PE</h1>
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="grid-categorias" id="listaCategorias">
                ...
                <div class="categoria-item" onclick="selecionar(this, 'Rígida')">Rígida</div>
        ...
        <div class="card">
            <h3>Lembretes Obrigatórios</h3>
            <div class="alerta">
                <p style="font-weight: bold; margin-bottom: 10px;">Equipamentos de Segurança:</p>
                <ul>
                    <li>Capacete Integral (Full Face) com trava.</li>
                    <li>Protetor de coluna ou Colete.</li>
                    <li>Joelheiras e luvas.</li>
                    <li>Calçado fechado resistente.</li>
                </ul>
                <p style="margin-top: 10px; font-size: 12px; font-weight: bold; color: #e74c3c;">
                    <i class="fas fa-exclamation-triangle"></i> O descumprimento ocasionará punição ou desclassificação imediata.
                </p>
            </div>
        </div>
    </div>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Pagamento - Downhill PE</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
        body { background: #001a4d; color: white; display: flex; flex-direction: column; align-items: center; min-height: 100vh; padding: 20px; }
        ...
        .header-pagamento i { font-size: 50px; color: #27ae60; margin-bottom: 15px; }
        .header-pagamento h2 { color: #003399; margin-bottom: 5px; }
        ...
        .resumo-item { display: flex; justify-content: space-between; margin-bottom: 10px; font-size: 14px; }
        .resumo-item span:first-child { color: #888; }
        .resumo-item span:last-child { font-weight: bold; color: #333; }

        .valor-total { border-top: 1px solid #ddd; padding-top: 10px; font-size: 18px; color: #003399; font-weight: 900; }

        .pix-box { background: #e8f5e9; border: 2px solid #27ae60; border-radius: 12px; padding: 15px; margin-top: 20px; }
        .pix-chave { font-size: 12px; color: #27ae60; word-break: break-all; margin: 10px 0; font-family: monospace; font-weight: bold; }
        ...
        .btn-copiar:active { transform: scale(0.95); }

        .aviso-comprovante { font-size: 11px; color: #e67e22; margin-top: 15px; font-weight: bold; }
...
<body>
    ...
    <div class="container-pagamento">
        <div class="header-pagamento">
            ...
            <p style="font-size: 13px;">Use o PIX para confirmar sua vaga</p>
        </div>

        <div class="resumo-pedido">
            <div class="resumo-item">
                <span>Etapa:</span>
                <span id="resumo-etapa">---</span>
            </div>
            <div class="resumo-item">
                <span>Categoria:</span>
                <span id="resumo-categoria">---</span>
            </div>
            <div class="valor-total resumo-item">
        ...
        <div class="pix-box">
            <p style="font-size: 12px; font-weight: bold; color: #27ae60;">PIX COPIA E COLA</p>
            <div class="pix-chave" id="chave-pix">00020126360014br.gov.bcb.pix0114SUACHAVEAQUI5204000053039865404120.005802BR5913ORGANIZADOR6008SAOPAULO62070503***6304</div>
            <button class="btn-copiar" onclick="copiarPix()">COPIAR CÓDIGO PIX</button>
        </div>

        <p class="aviso-comprovante">
            <i class="fas fa-info-circle"></i> Após pagar, envie o comprovante!
        </p>

        <a href="#" id="link-whatsapp" class="btn-whatsapp">
            <i class="fab fa-whatsapp"></i> ENVIAR COMPROVANTE
        </a>

        <a href="index.html" style="display: block; margin-top: 20px; color: #888; text-decoration: none; font-size: 12px;">Voltar ao Painel</a>
    </div>

    <script>
        document.addEventListener('DOMContentLoaded', () => {
            // Puxa os dados salvos das telas anteriores
            const etapa = localStorage.getItem('etapaAtiva') || "Não selecionada";
            const categoria = localStorage.getItem('categoriaFinal') || "Não selecionada";
            const valor = localStorage.getItem('valorFinal') || "120,00";
            const piloto = JSON.parse(localStorage.getItem('usuarioPiloto'));
            const nomePiloto = piloto ? piloto.nome : "Piloto";

            document.getElementById('resumo-etapa').innerText = etapa;
            document.getElementById('resumo-categoria').innerText = categoria;
            document.getElementById('resumo-valor').innerText = `R$ ${valor}`;

            // Configura o link do WhatsApp com a mensagem automática
            const mensagem = `Olá Organizador! Segue comprovante de inscrição:\n\n*Atleta:* ${nomePiloto}\n*Etapa:* ${etapa}\n*Categoria:* ${categoria}\n*Valor:* R$ ${valor}`;
            const fone = "5581999999999"; // COLOQUE SEU TELEFONE AQUI
            document.getElementById('link-whatsapp').href = `https://wa.me/${fone}?text=${encodeURIComponent(mensagem)}`;
        });

        function copiarPix() {
            const texto = document.getElementById('chave-pix').innerText;
            navigator.clipboard.writeText(texto).then(() => {
                alert("Código PIX copiado! Vá ao app do seu banco e use a opção 'PIX Copia e Cola'.");
            });
        }
    </script>
</body>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Inscrição Caruaru 2026</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
        body { background: #f0f2f5; color: #333; padding-bottom: 100px; }
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Inscrição Santa Cruz 2026</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
        body { background: #f0f2f5; color: #333; padding-bottom: 100px; }
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Inscrição Gravatá 2026</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
        body { background: #f0f2f5; color: #333; padding-bottom: 100px; }
